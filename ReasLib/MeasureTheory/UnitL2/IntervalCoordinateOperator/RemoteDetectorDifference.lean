...
/-!
# Remote-detector differences

This module records norm, pairing, and convergence estimates for differences
between determinant vectors and their remote copies.
-/
