...
/-!
# Strict positivity of the positive operator

This module proves strict positivity of the rational-time positive operator
using injectivity of interval-coordinate synthesis.
-/
