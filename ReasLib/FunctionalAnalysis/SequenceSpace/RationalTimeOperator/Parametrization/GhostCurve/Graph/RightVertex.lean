...
/-!
# Folded right vertices in the ghost graph

This module places folded right-hand detector vertices in the ghost graph and
derives their monotone-polar pairing-gap bound.
-/
