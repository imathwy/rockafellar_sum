...
/-!
# Maximality of the ghost-curve operator

This module identifies the monotone polar of the ghost-curve operator graph
with the graph itself and concludes maximal monotonicity.
-/
